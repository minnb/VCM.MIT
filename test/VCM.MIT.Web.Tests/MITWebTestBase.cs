...
{
    public abstract class MITWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MITWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MITWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MITDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MITDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MITDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MITDbContext, Task<T>> func)
        {
            T result;
